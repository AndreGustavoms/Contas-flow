...
export function DatePicker({ value, onChange, disabled, placeholder = "dd/mm/aaaa", min }: DatePickerProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {/* Calendar dropdown */}
      {open && (
        <div className="absolute z-50 bottom-full mb-2 w-72 overflow-hidden rounded-2xl border border-[color:var(--accent-border)] bg-[color:var(--card)] shadow-[0_20px_56px_-8px_var(--accent-glow),0_8px_24px_-4px_rgba(0,0,0,.7)]">
